...
class SaveAvif:
    ...
    def INPUT_TYPES(s):
        return {"required":
                ...
                "optional":
                    {"subsampling":(["4:2:0", "4:2:2", "4:4:4"], {"default": "4:2:0"})},
                }
    ...
    def save_avif(self, images, filename_prefix="ComfyUI", c_quality=75, enc_speed=6, subsampling="4:2:0", prompt=None, extra_pnginfo=None):
        ...
        for image in images:
            ...
            img.save(os.path.join(full_output_folder, file), quality= c_quality, speed= enc_speed, subsampling= subsampling, exif= img_exif)
